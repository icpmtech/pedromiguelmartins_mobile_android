...
import net.azurewebsites.pedromiguelmartins.pedromiguelmartins.ContactFragment.OnListFragmentInteractionListener;
import net.azurewebsites.pedromiguelmartins.pedromiguelmartins.contact.ContactContent;

import java.util.List;

/**
 * {@link RecyclerView.Adapter} that can display a {@link ContactContent.ContactItem} and makes a call to the
...
public class MyContactRecyclerViewAdapter extends RecyclerView.Adapter<MyContactRecyclerViewAdapter.ViewHolder> {
    ...
    public MyContactRecyclerViewAdapter(Context mContext, List<ContactContent.ContactItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
