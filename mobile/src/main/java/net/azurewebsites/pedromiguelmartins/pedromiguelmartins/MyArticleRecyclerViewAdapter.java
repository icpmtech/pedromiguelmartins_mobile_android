...
import net.azurewebsites.pedromiguelmartins.pedromiguelmartins.ArticleFragment.OnListFragmentInteractionListener;
import net.azurewebsites.pedromiguelmartins.pedromiguelmartins.article.ArticleContent;

import java.util.List;

/**
 * {@link RecyclerView.Adapter} that can display a {@link ArticleContent.ArticleItem} and makes a call to the
...
public class MyArticleRecyclerViewAdapter extends RecyclerView.Adapter<MyArticleRecyclerViewAdapter.ViewHolder> {
    ...
    public MyArticleRecyclerViewAdapter(Context mContext, List<ArticleContent.ArticleItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
