...
public class ResumeContent {
    ...
    private static ResumeItem createDummyItem(int position) {
        return new ResumeItem(String.valueOf(position), "Item " + position, makeDetails(position), makeDetails(position), Utils.GetProjectsListImages()[0], String.valueOf(position));
    }
    ...
    public static class ResumeItem {
        ...
        public ResumeItem(String title, String content, String details, String summary, Integer thumbnail, String id) {
            this.title = title;
